 ...
 **/
  ...
  **/
    async clickElementJS(selector: string) {
        await this.page.$eval(selector, (element: HTMLElement) => element.click());
    }
    /**
 * @param  WebElement
 ...
 **/
  ...
  **/
   ...
   **/
    async verifyJSElementValue(locator: any | Locator, text: string) {
   ...
   **/
    async typeAndEnter(locator: Locator, text: string) {
     ...
     **/
    async typeAndTab(locator: Locator, text: string) {
        await locator.type(text);
    ...
    async clearAndTypeTab(locator: Locator, text: string) {
        await this.waitForLocator(locator);
        await locator.fill(text);
        await locator.press('Tab');
    }
    async clearAndTypeEnter(locator: Locator, text: string) {
        await this.waitForLocator(locator);
        await locator.fill(text);
        await locator.press('Enter', { 'timeout': 3000 });
    }
    async typePauseEnter(locator: Locator, text: string) {
        await locator.fill(text);
     ...
     **/
    async typeInAlert(locator: Locator, text: string) {
    ...
    async holdAndClick(locator: Locator) {
        await locator.click({ delay: 3100 });
